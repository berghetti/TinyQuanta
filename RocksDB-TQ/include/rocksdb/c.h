...
/* added by ZL */
extern ROCKSDB_LIBRARY_API void rocksdb_get_in_place(
    rocksdb_t* db, const rocksdb_readoptions_t* options, const char* key,
    size_t keylen, char* val, size_t* vallen, char** errptr);

extern ROCKSDB_LIBRARY_API void rocksdb_scan(
...
/* added by ZL */
extern ROCKSDB_LIBRARY_API rocksdb_slicetransform_t*
    rocksdb_slicetransform_create_capped_prefix(size_t prefixLen);
