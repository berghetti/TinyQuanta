...
CXX_FLAGS := -emit-llvm -g -S -O3 -I. -I./include -pthread -DOS_LINUX -DLEVELDB_PLATFORM_POSIX -DSNAPPY -DNDEBUG -fPIC
...
tq_pass:
	...
	$(OPT) -S $(OPT_FLAGS) < leveldb.ll > leveldb.opt.ll

	$(OPT) -S $(CP_FLAGS) < leveldb.opt.ll > leveldb_cp.ll
# cheap_preempt
	$(CXX) -c -O3 -fPIC leveldb_cp.ll -o leveldb_cp.o
# clear
	$(CXX) -c -O3 -fPIC leveldb.opt.ll -o leveldb.o
	
	$(LLVM_AR) $(ARFLAGS) libleveldb_tq.a leveldb_cp.o
	$(LLVM_AR) $(ARFLAGS) libleveldb_clear.a leveldb.o
